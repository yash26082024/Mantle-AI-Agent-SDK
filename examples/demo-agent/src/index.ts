...
import { Agent, Observer, GeminiProvider } from "../../../sdk/src";
import type { AgentConfig } from "../../../sdk/src";
...
async function main() {
  const config: AgentConfig = {
    ...
    executorAddress: process.env.EXECUTOR_ADDRESS || "", // Deployed MantleAgentExecutor address
    privateKey: process.env.PRIVATE_KEY || "",
  };

  const geminiApiKey = process.env.GEMINI_API_KEY || "";
  const treasuryAddress = ""; // Actual treasury address
