...
export class AssetUtils {
    static factoryInterface = new ethers.Interface(FACTORY_ABI);
    /**
     ...
     */
    static createTokenAction(factoryAddress, name, symbol, initialSupply) {
     ...
     */
    static createNFTAction(factoryAddress, name, symbol) {
     ...
     */
    static createNFTWithMintAction(factoryAddress, name, symbol, tokenURI, receiver) {
